...
public class WebHookController {
    ...
    public WebHookController(UserResource userResource, RoleResource roleResource, StripeConfig stripeConfig) {
    ...
    private void handleSubscriptionCreated(Event event) throws StripeException {
        ...
        if (dataObjectDeserializer.getObject().isPresent()) {
            ...
            TierUser tierUser = TierUser.fromString(getTierBasedOnPriceId(stripePlanId));
    ...
    private String getTierBasedOnPriceId(String priceId) {
        if (priceId.equals(stripeConfig.getStripePriceIdFree())) return "FREE";
        if (priceId.equals(stripeConfig.getStripePriceIdBasic())) return "TIER1";
        if (priceId.equals(stripeConfig.getStripePriceIdPremium())) return "TIER2";
        if (priceId.equals("ENTERPRISE")) return "ENTERPRISE";
        if (priceId.equals("UNLIMITED")) return "UNLIMITED";
        throw new IllegalStateException("Unexpected price ID: " + priceId);
    }
}
